...
const ITEM_OPTIONS = {
  'Aromáticas': ['Frutos rojos', 'Manzanilla', 'Hierbabuena', 'Menta'],
  ...
  'Sodas saborizadas': ['Frutas rojas', 'Amarillas'],
...
const ALL_ITEMS = [
  ...
  { name: 'Copa de vino caliente', price: 12 }, { name: 'Infusión de frutas', price: 7 },
  ...
  { name: 'Nachos mixtos', price: 16.5 }, { name: 'Quesadillas x4', price: 12 },
  { name: 'Patacones con ahogado x4', price: 6 },
  ...
  { name: 'Sándwich de pollo', price: 10 },
  ...
  { name: 'Guacamole', price: 4 }, { name: 'Porción de salsa', price: 3 },
  { name: 'Porción de pollo o carne', price: 4 }, { name: 'Porción de queso cuajada o doble crema', price: 4 },
];
